...
const highlights = [
  ...
  { name: 'Podcastok', location: 'Multimédia', emoji: '🎤', color: '#00bf63' },
  { name: 'Bánki legerősebb embere', location: 'A. ép kondi', emoji: '🏋️', color: '#ffde59', dark: true },
...
const programs = [
  ...
  { id: 6,  name: 'Bánki legerősebb embere',     location: 'A ép. kondi terem',           time: 'egész nap',   type: 'allday',  teacher: 'Fekete Gábor',               desc: 'Súlyemelőverseny kreatív erőpróbákkal – ki a Bánki legerősebb embere 2026-ban? Különböző fizikai kihívások várnak egész nap.' },
  { id: 7,  name: 'Foci bajnokság',              location: 'Tesi terem',                     time: 'egész nap',   type: 'allday',  teacher: 'Zwickl-Szabó Judit',         desc: 'Osztályok közötti futballtorna a ketrecpályán – verbuválj csapatot és küzdj a bajnoki cím megszerzéséért!' },
  { id: 8,  name: 'ST Cinema Club',              location: 'B10',           time: 'egész nap',   type: 'allday',  teacher: 'Seffer Tímea',               desc: 'Filmvetítés nyugodt környezetben, ahol a diákok kikapcsolódhatnak és közösen nézhetnek meg egy alkotást.' },
  ...
  { id: 11, name: 'Jiu-jitsu próbaedzés',        location: 'A ép. Balneo',                     time: '09:00',       type: 'fixed',   teacher: 'Balogh Dárius',              desc: 'Ingyenes bevezető edzés a brazil jiu-jitsu alapjaiba – előképzettség nem szükséges, csak jó hangulat és egy kis bátorság.' },
  ...
  { id: 16, name: 'Plázs',                       location: 'Aula',                time: 'egész nap',   type: 'allday',  teacher: 'DÖK',                        desc: 'Közösségi tér DJ-vel, podcast-szerű beszélgetős műsorokkal (tanár-diák, diák-diák, tanár-tanár) és limonádéval – a nap szíve.' },
